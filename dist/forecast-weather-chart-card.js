  ...
  render({config, _hass, weather} = this) {
    ...
    if (!weather || !weather.attributes) {
      return x`
        ...
        <ha-card header="${l(hasCardTitle ? config.title : undefined)}">
          <div class="card">
